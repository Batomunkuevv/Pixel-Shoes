...
window.addEventListener("DOMContentLoaded", () => {
    ...
    let center = [55.752478, 37.771615];

    function init() {
        let map = new ymaps.Map("map__body", {
            center: center,
            zoom: 17,
        });
        ...
        if (window.screen.width > 768) {
            let placemark = new ymaps.Placemark(
                ...
                {},
                {
                    ...
                    iconImageHref: "images/main-page/map/placemark.svg",
                    iconImageSize: [81, 97],
    ...
    let swiperAdvantagesOptions = {
        ...
        navigation: {
            nextEl: ".slider-advantages__next",
            prevEl: ".slider-advantages__prev",
        },
    ...
    let swiperAdvantages = new Swiper(".slider-advantages", swiperAdvantagesOptions);

    //*</Sliders>=================================================================================================

    //*<Slider Journal>=================================================================================================

    let swiperJournalOptions = {
        direction: "horizontal",
        spaceBetween: 20,
        speed: 500,
        grabCursor: true,
        ...
        breakpoints: {
            ...
            400: { slidesPerView: 3.25 },
            576: { slidesPerView: 3.4 },
            768: {},
            1200: {},
        },
    };

    let swiperJournal = new Swiper(".slider-journal", swiperJournalOptions);

    //*</Slider Journal>=================================================================================================

    //*<Slider Pixel Prime info>=================================================================================================

    let swiperInfoOptions = {
        direction: "horizontal",
        slidesPerView: 1,
        simulateTouch: false,
        loop: true,
        ...
        navigation: {
            nextEl: ".slider-pixelprime__next",
            prevEl: ".slider-pixelprime__prev",
        },
    ...
    let swiperInfo = new Swiper(".slider-info", swiperInfoOptions);

    //*</Slider Pixel Prime info>=================================================================================================

    //*<Slider Pixel Prime>=================================================================================================

    let swiperPixelOptions = {
        direction: "horizontal",
        slidesPerView: "auto",
        spaceBetween: 30,
        simulateTouch: false,
    ...
    let swiperPixel = new Swiper(".slider-pixelprime", swiperPixelOptions);
    ...
    let swiperArticles = new Swiper(".slider-articles", swiperArticlesOptions);
    ...
    let swiperCards = new Swiper(".slider-cards", swiperCardsOptions);

    //*</Slider cards>=================================================================================================

    //*<Slider trends>=================================================================================================

    let swiperTrendsOptions = {
        direction: "horizontal",
        spaceBetween: 30,
        speed: 1000,
        loop: true,
    ...
    let swiperTrends = new Swiper(".slider-trends", swiperTrendsOptions);

    //*</Slider trends>=================================================================================================

    //*<Slider trends>=================================================================================================

    let swiperCertificatesOptions = {
        direction: "horizontal",
        spaceBetween: 21,
        speed: 1000,
        loop: true,
        ...
        slidesPerView: 3,
        navigation: {
            nextEl: ".slider-certificates__next",
            prevEl: ".slider-certificates__prev",
        },

        breakpoints: {
            100: { slidesPerView: 1.07 },
    ...
    let swiperCertificates = new Swiper(".slider-certificates", swiperCertificatesOptions);

    //*</Slider trends>=================================================================================================

    //*<Slider Links>=================================================================================================

    let swiperLinksOptions = {
        direction: "horizontal",
        spaceBetween: 7,
        slidesPerView: 3.2,
        speed: 1000,
    ...
    let swiperLinks = new Swiper(".slider-links", swiperLinksOptions);

    //*</Slider Links>=================================================================================================

    //*<Clean br>=================================================================================================

    const textItemAdvantages = document.querySelector('[data-change="br"]');

    if (textItemAdvantages != null) {
        if (window.screen.width < 576) {
            textItemAdvantages.innerHTML = `<p>
			Красота — такая же базовая потребность, как сон
			или еда. Детям нравится наряжаться, а родителям нравится<br> наряжать детей. Мы делаем красоту лёгкой, понятной и экономически доступной и умеем сочетать это с заботой о
			здоровье. Обувь может быть комфортной и красивой!
		</p>`;
        }
    }
    ...
    const search = document.querySelector(".search-header"),
        searchInput = document.querySelector(".search-header__input"),
        searchButton = document.querySelector(".search-header__button");
    ...
    if (search != null) {
        search.addEventListener("click", (e) => {
            ...
            searchInput.setAttribute("placeholder", "Поиск по блогу");
        });
    }
...
$(document).ready(function () {
    ...
    const modalOpen = $(".header__btn"),
        overlay = $(".overlay"),
        modalClose = $(".modal__close"),
        modalBody = $(".modal__body"),
        dropdownBtn = $(".dropdown__button"),
        dropdownList = $(".dropdown__list"),
        dropdownListItems = $(".dropdown__list-item"),
        dropdownInput = $(".dropdown__input-hidden"),
        inputTel = $('[data-input="tel"]'),
        inputEmail = $('[data-input="email"]');

    $(dropdownListItems).each(function (i, item) {
        $(item).click(function (e) {
            e.stopPropagation();
            $(dropdownBtn).text($(this).text());
            $(dropdownInput).attr("value", `${$(this).text()}`);
            $(dropdownList).slideToggle(500);
            $(dropdownBtn).removeClass("active");
            if ($(this).text() == "Электронная почта") {
                $(inputTel).addClass("form-modal__item_hidden");
                $(inputEmail).removeClass("form-modal__item_hidden");
            } else {
                $(inputTel).removeClass("form-modal__item_hidden");
                $(inputEmail).addClass("form-modal__item_hidden");
            }
